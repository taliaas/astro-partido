      ...
      <form @submit.prevent="submitForm" class="p-8 space-y-3">
        ...
        <div class="space-y-2">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="w-3/4">
              <label for="hora" class="block text-md font-medium text-gray-700"
                >Hora</label
              >
              <Input
                type="time"
            ...
            <div class="w-3/4">
              <label for="lugar" class="block text-md font-medium text-gray-700"
                >Lugar</label
              >
              <Input
                type="text"
...
const submitForm = async () => {
  ...
  try {
    const cp = { foata, ...await selectedNucleo.value};
    return await service.createMinute(cp);
  } catch (e) {
    console.log(e);
  }
};
